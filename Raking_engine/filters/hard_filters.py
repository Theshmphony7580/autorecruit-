...
class HardFilter:
    ...
    def is_rejected(self, candidate: dict) -> bool:
        ...
        # Only check honeypot CSV if this ID exists in it.
        # On a new/hidden dataset, IDs won't be in the CSV — fall through gracefully.
        if cid and cid in self.behavior_df.index:
