...
DEFAULT_BEHAVIOR_CSV    = os.path.join(DATA_DIR, 'candidate_behavior_scores_full.csv')
DEFAULT_BUNDLES_CSV     = os.path.join(DATA_DIR, 'frequent_skill_bundles.csv')
DEFAULT_EMBEDDINGS_NPY  = os.path.join(DATA_DIR, 'candidate_embeddings.npy')
DEFAULT_EMBEDDINGS_IDS  = os.path.join(DATA_DIR, 'candidate_embeddings_ids.json')
DEFAULT_JD_SIMILARITY   = os.path.join(DATA_DIR, 'jd_similarity_scores.csv')
